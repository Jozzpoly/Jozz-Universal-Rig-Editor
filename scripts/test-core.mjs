...
runNode(['--test', 'tests/core/core.test.mjs', 'tests/core/representation-binding.test.mjs', 'tests/core/project-contract.test.mjs', 'tests/core/mechanical-relations.test.mjs']);
