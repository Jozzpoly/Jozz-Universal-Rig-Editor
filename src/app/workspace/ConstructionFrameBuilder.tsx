...
import './construction-frame-builder.css';
...
export function ConstructionFrameBuilder({ inspection, adoptionTargetName = null, disabled = false, onPreview }: ConstructionFrameBuilderProps) {
  ...
  return (
    <details className="binding-preview-card construction-frame-builder" data-construction-frame-builder>
      <summary className="construction-frame-summary">
        <span>
          <strong>Construct frame from SOURCE evidence</strong>
          <small>disposable recipe</small>
        </span>
        <span className="construction-summary-target">{adoptionTargetName ? `owner · ${adoptionTargetName}` : 'select authored owner'}</span>
      </summary>
      <div className="construction-frame-body">
        ...
        {construction?.error ? (
          ...
          <div className="construction-result" data-construction-locator={construction.locator}>
            ...
            <details className="construction-provenance">
        ...
        <button
          type="button"
          className="binding-preview-button construction-preview-button"
          disabled={!canPreview}
