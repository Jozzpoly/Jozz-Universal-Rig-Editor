...
/**
 * FC-8 semantic experiment only.
 *
 * This preserves the useful AUTHOR/TEST context-switch invariants without
 * making `inspect | author | represent | test` active application navigation
 * authority. The current App does not own or render this state machine.
 */
